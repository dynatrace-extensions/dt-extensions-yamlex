...
def remove_yaml_comments(obj: Any) -> Any:
    if isinstance(obj, CommentedBase):
        ...
        # data.ca.comment = None # type: ignore
        
        # if hasattr(data.ca.items, 'items'): # type: ignore
        #     for key in data.ca.items: # type: ignore 
        #         # Remove key comments
        #         data.ca.items[key] = [None, None, None, None] # type: ignore
...
# def remove_yaml_comments_from_dict(data: dict] -> dict:
#     erase_yaml_comments(data)

#     if isinstance(data, dict) or isinstance(data, CommentedMap):
#         new_data = {}
#         for k, v in data.items():
#             new_data[k] = remove_yaml_comments(path, v)
#         return new_data
            
#     elif isinstance(data, list) or isinstance(data, CommentedSeq):
#         new_data = []
#         for item in data:
#             new_data.append(remove_yaml_comments(path, item))
#         return new_data